// CSV Data Service for OSU CABS Traffic Data
...
class CSVDataService {
  ...
  // Get current time predictions for a specific stop
  getCurrentPredictions(stopName, currentTime = null) {
    ...
    // Find predictions for current time and day
  ...
  // Get next time slot predictions (for nextEta)
  ...
  // Convert CSV data to bus objects for the app
